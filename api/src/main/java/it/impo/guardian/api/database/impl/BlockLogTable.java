...
/**
 * Data access object for the block log table.
 *
...
public abstract class BlockLogTable {
    ...
    /**
     * Deletes a block log entry by its database id.
     *
    ...
    /**
     * Deletes every block log older than the given number of days.
     *
    ...
    /**
     * Counts the block logs recorded at a location.
     *
    ...
    /**
     * Returns a page of block logs recorded at a location, ordered from the most recent.
     *
    ...
    /**
     * Returns the block logs recorded within a cubic radius around a center and not older
    ...
    /**
     * Counts the block logs recorded for a player name.
     *
    ...
    /**
     * Returns a page of block logs recorded for a player name, ordered from the most recent.
     *
     * @param playerName the name of the player
     * @param limit      the maximum number of logs to return
     * @param offset     the number of logs to skip
