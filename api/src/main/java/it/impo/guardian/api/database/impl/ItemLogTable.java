...
/**
 * Data access object for the item log table.
 *
...
public abstract class ItemLogTable {
    ...
    /**
     * Deletes an item log entry by its database id.
     *
    ...
    /**
     * Deletes every item log older than the given number of days.
     *
    ...
    /**
     * Counts the item logs recorded at a location.
     *
    ...
    /**
     * Returns a page of item logs recorded at a location, ordered from the most recent.
     *
    ...
    /**
     * Counts the item logs recorded for a player name.
     *
    ...
    /**
     * Returns a page of item logs recorded for a player name, ordered from the most recent.
     *
     * @param playerName the name of the player
     * @param limit      the maximum number of logs to return
     * @param offset     the number of logs to skip
