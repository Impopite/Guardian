...
public abstract class InteractLogTable {
    ...
    public abstract CompletableFuture<Boolean> addLog(UUID userUuid, String username, String world, int x, int y, int z, String blockType, String action, boolean staff);
