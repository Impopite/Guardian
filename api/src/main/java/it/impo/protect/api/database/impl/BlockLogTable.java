...
public abstract class BlockLogTable {
    ...
    public abstract CompletableFuture<Boolean> addLog(UUID userUuid, String username, String world, int x, int y, int z, String blockType, String blockData, String action, boolean staff);
