...
public class ContainersRollbackCommand {
    ...
    public ContainersRollbackCommand(Guardian plugin) {
        this.plugin = plugin;
    }

    public CommandAPICommand get() {
        return new CommandAPICommand("containers")
                ...
                .executes((sender, args) -> {
                    ...
                    plugin.getRollbackManager().rollbackContainers(player, (int) args.get("raggio"), Duration.ofSeconds(seconds));
                });
    }
}
