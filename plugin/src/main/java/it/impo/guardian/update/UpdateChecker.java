package it.impo.guardian.update;
...
public class UpdateChecker {
    ...
    private static final String API_URL = "https://api.modrinth.com/v2/project/Guardian/version";
    ...
    public UpdateChecker(Guardian plugin) {
        this.plugin = plugin;
    ...
    private void check() {
        try {
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .header("User-Agent", "Guardian-" + plugin.getDescription().getVersion())
