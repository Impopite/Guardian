...
public class BlocksRollbackCommand {
    ...
    public dev.jorel.commandapi.CommandAPICommand get() {
        ...
        return new dev.jorel.commandapi.CommandAPICommand("blocks")
                ...
                .executes((sender, args) -> {
                    ...
                    plugin.getRollbackManager().rollbackBlocks(player, (int) args.get("raggio"), java.time.Duration.ofSeconds(seconds));
                });
    }
}
